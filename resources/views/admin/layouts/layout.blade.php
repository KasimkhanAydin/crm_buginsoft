...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/admin_files/assets/img/favicon.ico"/>
    <link href="/admin_files/assets/css/loader.css" rel="stylesheet" type="text/css" />
    <script src="/admin_files/assets/js/loader.js"></script>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,600,700&display=swap" rel="stylesheet">
    <link href="/admin_files/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="/admin_files/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="/admin_files/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="/admin_files/assets/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
...
<script src="/admin_files/assets/js/libs/jquery-3.1.1.min.js"></script>
<script src="/admin_files/bootstrap/js/popper.min.js"></script>
<script src="/admin_files/bootstrap/js/bootstrap.min.js"></script>
<script src="/admin_files/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="/admin_files/assets/js/app.js"></script>
<script>
    $(document).ready(function() {
        App.init();
    });
</script>
<script src="/admin_files/assets/js/custom.js"></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
<script src="/admin_files/plugins/apex/apexcharts.min.js"></script>
<script src="/admin_files/assets/js/dashboard/dash_1.js"></script>
<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
